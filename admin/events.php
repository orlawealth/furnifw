	 					...
	 					<?php 
	 						foreach ($events as $event) {
	 							echo '
	 								...
	 								<td><a class="text-primary" href="'.'view_event.php?id='.$event['event_id'].'">view</a></td>
	 								<td><a href="'. 'edit_event.php?id='.$event['event_id'].'">Edit</a></td>
									<td class ="text-danger"><a class ="text-danger" href="delete_event.php?id='.$event['event_id'].'">Delete</a></td>
	 								</tr>
	 							';
	 						}
	 					?>
